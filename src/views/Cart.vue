    ...
    <div class="container">
        <div class="row">
            ...
            <div v-for="cartItem in cartItems" :key="cartItem.id" class="row mt-2 pt-3">
                ...
                <!--dispaly product name, quantity-->
                <div class="col-md-5 px-3 justify-content-around">
                    <div class="card-block px-3">
                        <h6 class="card-title">
                            <router-link :to="{name: 'ShowDetails', params:{id: cartItem.product}}">
                    ...
                    <br/>
                    <a href="#" class="text-right" @click="deleteItem(cartItem.id)">Remove form cart</a>
                </div>
                <div class="col-2"></div>
