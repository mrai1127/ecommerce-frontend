<template>
    <div class="div_class">
        ...
        <div class="alert alert-primary"> while making payment use card number 4242 4242 4242 4242 and enter random date and
            cvv (3 digit)
        </div>
...
export default {
    data() {
        return {
            stripeAPIToken: 'pk_test_51NgBpcAzPF8k9S6wG5AnqmcHTfZudDoAxJFZyfejnwWiHXotwEbobu3m7p9tKrt6zDQRMxQBVMljXjBM9eDxTsr100kxNEdtBp',
            stripe: '',
            token: null,
            checkoutBodyArray: [],
        };
